...
#        fields = ('url', 'order_id', 'order_type', 'owner', 'order_symbol', 'order_stoploss', 'order_takeprofit', 'order_price' , 'order_lot')
        fields = ('id', 'order_id', 'order_type', 'owner', 'order_symbol', 'order_stoploss', 'order_takeprofit', 'order_price' , 'order_lot','order_status','message_id','order_create_time','order_open_time','order_close_time','order_comment')
